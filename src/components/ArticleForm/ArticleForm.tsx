import { SubmitHandler, UseFormRegister, UseFormHandleSubmit, FieldErrors, UseFieldArrayRemove } from 'react-hook-form'
...
export const ArticleForm = ({ register, handleSubmit, onSubmit, errors, fields, append, remove }: Props) => {
  return (
    <form className={classes.formArticle} onSubmit={handleSubmit(onSubmit)}>
      <div className={classes.wrapperField}>
        ...
        <input
          ...
          placeholder="Title"
        ></input>
        {errors.title ? <p className={classes.wrapperField__error}>{errors.title.message?.toString()}</p> : null}
      </div>
      <div className={classes.wrapperField}>
        ...
        ></input>
        {errors.description ? (
          <p className={classes.wrapperField__error}>{errors.description.message?.toString()}</p>
        ) : null}
      </div>
      <div className={classes.wrapperField}>
        ...
        <textarea
          ...
          placeholder="Text"
        ></textarea>
        {errors.text ? <p className={classes.wrapperField__error}>{errors.text.message?.toString()}</p> : null}
      </div>
